...
import { Box, Typography, Card, CardContent, CardMedia, LinearProgress,Chip,Stack } from '@mui/material';
        ...
        sx={{
          ...
          <Box display="flex" >
            ...
            <Typography variant="body2" color="text.secondary" marginTop={2}>
              ...
              <Typography gutterBottom color={blue[900]} variant="h6" component="div">
                Data Visualization with Python
              </Typography>
              <Typography variant="body2" color="text.secondary">
                Data visualization is the graphical representation of data in order to interactively and efficiently convey insights to clients.
              </Typography>
      ...
      <CourseBox>
        {courses.map((course, index) => (
          <CourseCard key={index}>
           ...
           color={blue[900]} variant="h6" component="div">
                {course.title}
              </Typography>
              <Typography 
              sx={{
