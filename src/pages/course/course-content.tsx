...
const CourseContent = () => {
  ...
  useEffect(() => {
    ...
    fetchModules();
  }, [id, getModules, handleModuleSelection]);

  const renderLessons = (module: ModuleDetailProps) => {
